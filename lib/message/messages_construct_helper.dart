...
class MessagesConstructHelper {
  ...
  dynamic subscribe(collection, {params}) {
    ...
    return new CargoPackage(collection, new CargoAction(CargoAction.SUBSCRIBE), _profileInfo, params: params);
  }
  ...
  dynamic set(collection, key, value) {
    return new CargoPackage(collection, new CargoAction(CargoAction.SET), _profileInfo, key: key, json: value);
  }
